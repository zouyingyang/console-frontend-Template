          ...
          <el-form class="fix-form" ref="form" label-position="top" label-width="80px" :model="form">
            <el-col :xs="24" :sm="11" :md="11" :lg="7" :xl="7">
              <el-form-item
                ...
                <el-input maxlength="50" v-model="form.name" placeholder="请输入仓库名称"/>
              </el-form-item>
            </el-col>
            ...
            <el-col :xs="24" :sm="11" :md="11" :lg="7" :xl="7">
              <el-form-item
                ...
                <el-input maxlength="50" v-model="form.url" placeholder="请输入仓库域名">
        ...
        <el-table
          ...
          <el-table-column label="成员姓名">
            <template slot-scope="scope">
              <el-input maxlength="50" v-if="scope.row.isCheck" v-model="scope.row.name" size="mini"></el-input>
          ...
          <el-table-column label="工号">
            <template slot-scope="scope">
              <el-input maxlength="50" v-if="scope.row.isCheck" v-model="scope.row.id" size="mini"></el-input>
          ...
          <el-table-column label="所属部门">
            <template slot-scope="scope">
              <el-input maxlength="50" v-if="scope.row.isCheck" v-model="scope.row.department" size="mini"></el-input>
  ...
  get member () {
    const member = this.form.member.map((item) => {
      if (!item.hasOwnProperty('isCheck')) {
        this.$set(item, 'isCheck', Object.values(item).includes(''))
      }
      return item
    })
    return member
